        ...
        <div class="container-fluid">
            ...
            <div class="row">
               ...
               <div class="jumbotron bg-gray">
                    <div class="container " > 
                    <center><h2 class="display-4">SELAMAT DATANG DI SCHEDULE MANAGER </h2> <br>
                    <p class="lead"> Gunakan sistem ini untuk mengatur waktu anda bersama teman, sahabat, dan keluarga.</p> <br>
                    <a href="buat_jadwal.php" class="btn btn-warning col-lg-3"><i class="fas fa-calendar-plus">&nbsp;Mulai Menggunakan</i></a></center>
                    </div>
               </div>
               </div>
            </div>
